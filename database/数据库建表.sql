...
//巨幕表
create table slide(
	slide_id int unsigned not null auto_increment comment '巨幕图片ID',
...
create table comment(
	...
	comment_content varchar(128) not null comment '评论内容',
	comment_date date not null comment '评论的日期',
	
	article_id int unsigned not null comment '评论的文章Id',
	user_id int unsigned not null comment '评论的用户Id',
